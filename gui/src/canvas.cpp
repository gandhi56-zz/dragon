...
int main(int argc, char *argv[])
{
    ...
    while (!glfwWindowShouldClose(win))
    {
		...
		*/
            ...
            points[2] = points[0]-a; points[3] = points[1]+b;
            points[4] = points[2]; points[5] = points[3]+L;
            points[6] = points[4]+a; points[7] = points[5]+b;
            points[8] = points[6]+a; points[9] = points[7]-b;
            points[10] = x+a; points[11] = y+b;
